...
FILES_${PN} = "${sysconfdir}/phosphor-logging/extensions/pels/message_registry.json"
...
do_install() {
    ...
    install -d ${D}${sysconfdir}/phosphor-logging/extensions/pels
    install -m 0644 ${S}/pels/registry/message_registry.json \
        ${D}${sysconfdir}/phosphor-logging/extensions/pels/
}
