...
DBUS_SERVICE_${PN}-sreset += "xyz.openbmc_project.Control.Host.NMI.service"

SYSTEMD_SERVICE_${PN} += "xyz.openbmc_project.Control.Host.NMI.service"
SYSTEMD_SERVICE_${PN} += "nmi.service"
